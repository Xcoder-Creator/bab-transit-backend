            ...
            loginSchema.validate(data)
                .then((validatedUser) => {
                    ...
                    var login_process = async () => {
                        let result1 = await db_query.check_driver_phone_no(user_phone_no);
                        ...
                        if (result1.status === false){
                            ...
                            if (result1.data.length > 0 && result1.data.length === 1){
                                let driver_id = result1.data[0].driver_id;
                                ...
                                if (result1.data[0].verification_status	=== 0){
                                    ...
                                    if (result2.status === false){
                                        ...
                                        let result2 = await db_query.store_driver_verification_code(driver_id, verification_code, verif_token);
                                        ...
                                        if (result2.status === false){
                                            ...
                                            res.statusCode = 400;
                                            res.json({ err_msg: 'Can\'t login, please verify your account first', result: { user_id: driver_id }, succ_msg: null, res_code: 315 });
                                        }
                                    }
                                    ...
                                    let driver_id = result1.data[0].driver_id;
                                    let hashed_password_from_db = result1.data[0].driver_password;
